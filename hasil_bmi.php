                ...
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-body">
                            ...
                            <h3 class="text-center text-bold">Dengan Status <b
                                    class="text-warning"><?=$bmi4->statusBMI()?></b></h3>
                            <p class="text-center text-bold">Makan Yang Banyak Yah Kak Biar Normal Wkwkw</p>
                            <?php    
                            } else if ($bmi4->statusBMI() == 'Normal (Ideal)')  { ?>
                            <h3 class="text-center text-bold">Dengan Status <b
                                    class="text-success"><?=$bmi4->statusBMI()?></b></h3>
                            <p class="text-center text-bold">Pertahankan Bobot Badanya Ka!</p>
                            <?php    
                            } else if ($bmi4->statusBMI() == 'Kelebihan berat badan')  { ?>
                            <h3 class="text-center text-bold">Dengan Status <b
                                    class="text-primary"><?=$bmi4->statusBMI()?></b></h3>
                            <?php    
                            } else if ($bmi4->statusBMI() == 'Kegemukan (Obesitas)')  { ?>
                            <h3 class="text-center text-bold">Dengan Status <b
                                    class="text-danger"><?=$bmi4->statusBMI()?></b></h3>
                            <?php    
                            } ?>


                            <a href="form_bmi.php" class="text-white btn btn-warning btn-sm text-decoration-none"><i
                                    class="fas fa-redo"></i>
                                Hitung
                                Ulang</a>
