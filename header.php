    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="form_bmi.php" class="nav-link">Kalkulator Sehat</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Nurkholifah</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="praktikum 1" target= "blank" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="praktikum 2" target="blank" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>
                                    Praktikum 2
                        ...
                        <li class="nav-item">
                            <a href="praktikum 3" target="blank" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>
                                    Praktikum 3
                        ...
                        <li class="nav-item">
                            <a href="praktikum 4" target="blank" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>
                                    Praktikum 4
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="praktikum 5" target="blank" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>
                                    Praktikum 5
                                </p>
